...
{
    Teamcenter::Soa::Client::Connection::Protocol protocol = Teamcenter::Soa::Client::Connection::HTTP;
...
Teamcenter::Soa::Client::Model::User* AppSession::login(string discriminator, AppCredentialManager* credentialManager)
{
    ...
    try
    {
        Teamcenter::Services::Core::_2006_03::Session::LoginResponse loginResponse = 
            sessionService->login(credentialManager->getUserName(), credentialManager->getPassword(), "", "", discriminator);
