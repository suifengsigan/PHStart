        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  CgfxMattexBuilder : public Builder
        {
            ...
            /** The texture space type indicates the texture space type to use for CgFX shader.
             ...
             <br>  @deprecated Deprecated in NX7.5.2.  Use @link Display_CgfxMattexBuilder::textureSpaceShader Display_CgfxMattexBuilder::textureSpaceShader@endlink  instead. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX7.5.2.  Use Display_CgfxMattexBuilder::textureSpaceShader instead.") enum TextureSpace
            {
