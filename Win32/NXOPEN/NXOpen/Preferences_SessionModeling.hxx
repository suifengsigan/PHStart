        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SessionModeling
        {
            ...
            */
            ...
            /**Returns Returns the flag to activate the feature group with rollback or not, if the flag is true, the highest member feature will be made as current feature
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: bool ActivateFeatureGroupWithRollback
            (
            );
            /**Sets Returns the flag to activate the feature group with rollback or not, if the flag is true, the highest member feature will be made as current feature
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
