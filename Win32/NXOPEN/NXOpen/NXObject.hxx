    ...
    */
    class NXOPENCPPEXPORT  NXObject : public TaggedObject, public virtual INXObject
    {
        ...
        struct  AttributeInformation
        {
            ...
            public: /** Boolean (logical) attribute value (default value when reading templates of non-set attributes) */bool BooleanValue;
            public: /** Integer attribute value (default value when reading templates of non-set attributes) */int IntegerValue;
            public: /** Real attribute value (default value when reading templates of non-set attributes) */double RealValue;
            public: /** String attribute value (default value when reading templates of non-set attributes). */NXString StringValue;
            public: /** Time/Date attribute value(default value when reading templates of non-set attributes).
                                                         See @link NXObject::DateAndTimeFormat NXObject::DateAndTimeFormat@endlink 
                                                         for valid formats. */NXString TimeValue;
            ...
            public: /** The unit, if any, if the attribute is a real-type attribute */NXOpen::Unit * Unit;
            ...
            public: AttributeInformation(NXOpen::NXObject::AttributeType typeInitial /** Attribute type */, 
                    ...
                    bool booleanValueInitial /** Boolean (logical) attribute value (default value when reading templates of non-set attributes) */, 
                    int integerValueInitial /** Integer attribute value (default value when reading templates of non-set attributes) */, 
                    double realValueInitial /** Real attribute value (default value when reading templates of non-set attributes) */, 
                    const NXString &stringValueInitial /** String attribute value (default value when reading templates of non-set attributes). */, 
                    const NXString &timeValueInitial /** Time/Date attribute value(default value when reading templates of non-set attributes).
                                                                 See @link NXObject::DateAndTimeFormat NXObject::DateAndTimeFormat@endlink 
                                                                 for valid formats. */, 
                    ...
                    NXOpen::Unit * unitInitial /** The unit, if any, if the attribute is a real-type attribute */) :
                Type(typeInitial),
