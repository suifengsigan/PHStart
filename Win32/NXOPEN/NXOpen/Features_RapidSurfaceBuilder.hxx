        ...
        */
        class NXOPENCPP_FEATURESEXPORT  RapidSurfaceBuilder : public Features::FeatureBuilder
        {
            ...
            /** Set number of define points (pre-NX6) 
             <br>  @deprecated Deprecated in NX6.0.0.  Use @link JA_RAPID_SURFACE_BUILDER_set_number_of_defining_points JA_RAPID_SURFACE_BUILDER_set_number_of_defining_points@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0.  Use JA_RAPID_SURFACE_BUILDER_set_number_of_defining_points instead.") void SetNumberOfDefinePoints
            (
                int number /** Number of Defined Points */
            );
            /** Set a define point (pre-NX6) 
             <br>  @deprecated Deprecated in NX6.0.0.  Use @link JA_RAPID_SURFACE_BUILDER_set_defining_point JA_RAPID_SURFACE_BUILDER_set_defining_point@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0.  Use JA_RAPID_SURFACE_BUILDER_set_defining_point instead.") void SetADefinePoint
            (
                int index /** Index of Defined Point */,
