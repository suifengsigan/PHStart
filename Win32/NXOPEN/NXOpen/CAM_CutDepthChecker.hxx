    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  CutDepthChecker : public Builder
        {
            ...
            /**Returns  indicator to stop when the number of gouges has equalled the stop limit 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: bool StopOnLimit
            (
            );
            /**Sets  indicator to stop when the number of gouges has equalled the stop limit 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets  indicator to display gouges 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets  indicator to create curves for the gouged motions 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
