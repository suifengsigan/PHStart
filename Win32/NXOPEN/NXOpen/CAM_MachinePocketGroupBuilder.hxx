...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        ...
        {
            /** the register type 
             <br>  @deprecated Deprecated in NX8.5.0.  This @link JA_MACHINE_POCKET_GROUP_BUILDER_register_type JA_MACHINE_POCKET_GROUP_BUILDER_register_type@endlink  is no longer supported. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  This JA_MACHINE_POCKET_GROUP_BUILDER_register_type is no longer supported.") enum RegisterType
            {
