...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        ProportionalAllU (deprecated) </td> <td> 
         
        1 </td> </tr> 

        <tr><td> 
         
        ProportionalAllV (deprecated) </td> <td> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  StudioXformBuilderEx : public Features::FeatureBuilder
        {
            ...
            */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") enum AdvancedMethodType
            {
            ...
            /**Returns  the advanced method 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") NXOpen::Features::StudioXformBuilderEx::AdvancedMethodType AdvancedMethod
            (
            );
