        ...
        */
        class NXOPENCPP_CAEEXPORT  MeshControlBuilder : public Builder
        {
            ...
            /** Create weld face definition   @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::NXObject * AddWeldFaceDefinition
            (
            );
            ...
            (
                const std::vector<NXOpen::NXObject *> & ptFaceDefinitions /** ptfacedefinitions */ 
            );
            /** Auto create face definitions  @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: std::vector<NXOpen::NXObject *> AutoCreateWeldFaceDefinitions
            (
            );
            /** Get weld face definitions  @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: std::vector<NXOpen::NXObject *> GetWeldFaceDefinitions
            (
            );
            ...
            (
                NXOpen::NXObject * tFaceDefinition /** tfacedefinition */ 
            );
