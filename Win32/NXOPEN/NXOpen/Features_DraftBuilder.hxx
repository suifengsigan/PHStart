        ...
        */
        class NXOPENCPP_FEATURESEXPORT  DraftBuilder : public Features::FeatureBuilder
        {
            ...
            /**Sets  the stationary entity for draft
                      ...
                      Please use @link Features::DraftBuilder::StationaryReference Features::DraftBuilder::StationaryReference@endlink  instead.
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") void SetStationaryEntity
            (
            ...
            /**Returns  the stationary entity for draft
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") NXOpen::NXObject * StationaryEntity
            (
            );
