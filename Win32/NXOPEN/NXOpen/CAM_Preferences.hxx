        ...
        class NXOPENCPP_CAMEXPORT  Preferences : public Builder
        {
            ...
            */
            ...
            /**Returns  the chordal tolerance 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") double VisualizeChordalTolerance
            (
            );
            /**Sets  the chordal tolerance 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") void SetVisualizeChordalTolerance
            (
            ...
            /**Returns  the tilt tolerance 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") double VisualizeToolAxisTiltTolerance
            (
            );
            /**Sets  the tilt tolerance 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") void SetVisualizeToolAxisTiltTolerance
            (
