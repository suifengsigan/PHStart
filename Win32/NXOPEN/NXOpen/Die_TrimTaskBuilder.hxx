        ...
        */
        class NXOPENCPP_DIEEXPORT  TrimTaskBuilder : public Features::FeatureBuilder
        {
            ...
            (
                ...
                NXOpen::Plane * origStartPlaneTag /** Original start plane. */,
                NXOpen::Plane * origEndPlaneTag /** Original end plane. */,
                NXOpen::Plane ** targetStartPlaneTag /** Start plane in target operation. */,
                NXOpen::Plane ** targetEndPlaneTag /** End plane in target operation. */
            );
