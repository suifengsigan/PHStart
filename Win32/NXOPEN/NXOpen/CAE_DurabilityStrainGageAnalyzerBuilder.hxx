    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurabilityStrainGageAnalyzerBuilder : public Builder
        {
            ...
            /** Add gage data. 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link JA_DURABILITY_STRAIN_GAGE_ANALYZER_BUILDER_use_strain_gage_data JA_DURABILITY_STRAIN_GAGE_ANALYZER_BUILDER_use_strain_gage_data@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use JA_DURABILITY_STRAIN_GAGE_ANALYZER_BUILDER_use_strain_gage_data instead.") void AddStrainGageData
            (
