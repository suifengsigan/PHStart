        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  PartVisualizationShade
        {
            ...
            /**Returns  the angle tolerance for advanced visualization views. 
             ...
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0") double AdvancedVisViewAngleTolerance
            (
            );
            ...
            /**Returns  the width tolerance for advanced Visualization Views. 
             ...
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0") double AdvancedVisViewWidthTolerance
            (
            );
