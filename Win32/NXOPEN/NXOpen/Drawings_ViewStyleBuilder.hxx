    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewStyleBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /** Retrieve a specified Callout on the Flat Pattern Tab on the View Style Dialog  @return  Returns the particular Flat Pattern Callout sub-builder on View Style 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Retrieve a specified Curve on the Flat Pattern Tab on the View Style Dialog  @return  Returns the particular Flat Pattern Curve sub-builder on View Style 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
