        ...
        */
        class NXOPENCPP_CAMEXPORT  ToolAxisAdvanced : public TaggedObject
        {
            ...
            /**Returns  the leading angle 
             ...
             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") double LeadingAngle
            (
            );
            /**Sets  the leading angle 
             ...
             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") void SetLeadingAngle
            (
            ...
            /**Returns  the trailing angle 
             ...
             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") double TrailingAngle
            (
            );
            /**Sets  the trailing angle 
             ...
             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0") void SetTrailingAngle
            (
