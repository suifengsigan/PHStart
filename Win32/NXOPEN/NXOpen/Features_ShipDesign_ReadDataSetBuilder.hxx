        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ReadDataSetBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
            {
                ...
                /**Returns  If toggle is on the a file of the data set type can be retrieved from the Native file system 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
                public: bool NativeToggle
                (
                );
                /**Sets  If toggle is on the a file of the data set type can be retrieved from the Native file system 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") */
                ...
                /**Returns  If the toggle is on then the native file will be added to current work part as a data set 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
                public: bool CreateDataSetToggle
                (
                );
                /**Sets  If the toggle is on then the native file will be added to current work part as a data set 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") */
