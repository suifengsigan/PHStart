            ...
            */
            class NXOPENCPP_CAEEXPORT  DAOObjective : public NXObject
            {
                ...
                /**Returns  the Hooke's 2d location 
                 ...
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                public:  NX_DEPRECATED("Deprecated in NX8.5.0") NXOpen::CAE::Optimization::Hookes Hookes2dLocation
                (
                );
                /**Sets  the Hooke's 2d location 
                 ...
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_design_sim ("NX Design Simulation") */
                public:  NX_DEPRECATED("Deprecated in NX8.5.0") void SetHookes2dLocation
                (
